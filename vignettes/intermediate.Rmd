...
## `figlet`: A more complex program

For this walkthrough, we will be creating a module for the program
[`figlet`](http://www.figlet.org/) which takes textual input and returns ASCII
art.
...
```{r build-package}
module_build(flpth = flpth, tag = 'latest')
```
